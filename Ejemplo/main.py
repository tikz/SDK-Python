...
class New_Toplevel_1:
    def __init__(self, master=None):
        ...
        self.Button1.place(relx=0.18, rely=0.42, height=24, width=227)
        self.Button1.configure(activebackground="#d9d9d9")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background=_bgcolor)
        self.Button1.configure(command=main_support.configCommand)
        self.Button1.configure(disabledforeground="#a3a3a3")
        self.Button1.configure(foreground="#000000")
        self.Button1.configure(highlightbackground="#d9d9d9")
        self.Button1.configure(highlightcolor="black")
        self.Button1.configure(pady="0")
        self.Button1.configure(text='''Configure''')

        self.Label5 = Label(self.TNotebook1_pg0)
        self.Label5.place(relx=0.01, rely=0.09, height=21, width=94)
        ...
        self.Label5.configure(text='''OperationsWSDL''')

        self.Label6 = Label(self.TNotebook1_pg0)
        self.Label6.place(relx=0.01, rely=0.14, height=21, width=131)
        ...
        self.Label6.configure(text='''PaymentMethodsWSDL''')

        self.Entry2 = Entry(self.TNotebook1_pg0)
        self.Entry2.place(relx=0.15, rely=0.09, relheight=0.04, relwidth=0.4)
        ...
        self.Entry2.configure(textvariable=main_support.configOperationsWSDL)

        self.Entry5 = Entry(self.TNotebook1_pg0)
        self.Entry5.place(relx=0.15, rely=0.14, relheight=0.04, relwidth=0.4)
        ...
        self.Entry5.configure(textvariable=main_support.configPaymentMethodsWSDL)
